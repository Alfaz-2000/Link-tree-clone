    ...
    <section className="bg-[#d2e823] min-h-[100vh] grid grid-cols-2">
      ...
      <div className="flex justify-center flex-col ml-[10vw] gap-4">
        ...
        <div className="input flex gap-2">
          <input value={text} onChange={(e)=>{setText(e.target.value)}} className=" bg-white px-2 py-2 focus:outline-green-800 rounded-md" type="text" placeholder="Bittr.ee/your-url" />
          <button onClick={()=>{createTree()}} className="bg-[#323232] text-white rounded-full px-4 py-4 font-semibold">Get started for free</button>
        </div>
      </div>
